...
var Edit = (0,_wordpress_data__WEBPACK_IMPORTED_MODULE_4__.withSelect)(function (select) {
  ...
  var assigned = attributes.assigned,
  ...
  }), taxonomyTerms && taxonomyTerms.map(function (term) {
...
module.exports = JSON.parse('{"$schema":"https://schemas.wp.org/trunk/block.json","apiVersion":3,"name":"flashblocks/taxonomy-links","version":"0.1.0","title":"Taxonomy Links","category":"widgets","icon":"category","description":"Example block scaffolded with Create Block tool.","example":{},"attributes":{"assigned":{"type":"boolean","default":false},"taxonomy":{"type":"string","default":"category"},"terms":{"type":"array","default":[]}},"supports":{"align":["wide","full"],"anchor":true,"ariaLabel":true,"html":false,"color":{"gradients":true,"link":true},"spacing":{"margin":["top","bottom"],"padding":true,"blockGap":true},"dimensions":{"minHeight":true},"position":{"sticky":true},"typography":{"fontSize":true,"lineHeight":true}},"styles":[{"name":"style1","label":"Image & Button"}],"textdomain":"taxonomy-links","editorScript":"file:./index.js","editorStyle":"file:./index.css","style":"file:./style-index.css","render":"file:./render.php","//viewScript":"file:./view.js"}');
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunknavigation_mega"] = self["webpackChunknavigation_mega"] || [];
